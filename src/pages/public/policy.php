...
$departmentsData = array(
    ...
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/5_Social_Non_Discrimination.pdf",
    ...
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/6_Social_Equity_Policy.pdf",
    ...
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/8_Code_of_Conduct.pdf",
    ...
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/9_Faculty_Incentive.pdf",
    ...
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/10_Resource_Mobilisation.pdf",
        "iconFillColor" => "#0D1282",
        "description" => "Anna University",
    ),
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/11_Grievance_Redressal.pdf",
        "iconFillColor" => "#0D1282",
        "description" => "Anna University",
    ),
    array(
        ...
        "icon" => '<img src="src/assets/rpt.png" style="width: 70%;">',
        "link" => "/src/assets/Policy/12_Research_Promotion.pdf",
        "iconFillColor" => "#0D1282",
        "description" => "Anna University",
    ),
);
