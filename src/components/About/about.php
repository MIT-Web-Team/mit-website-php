...
<div className="outer-about-container noselect">
      ...
      <div className="unique-experiment-container">
        <div className="head-text-container"><div className="head-text">Unique Experiment</div></div>
        <div className="about-content">
      ...
      <div className="about-efforts-container">
        <div className="head-text-container"><div className="head-text">Humble Beginnings and Herculean Efforts</div></div>
        <div className="about-content">
