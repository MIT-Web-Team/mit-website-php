...
<div class="outer-about-container noselect">
      ...
      <div class="history-container">
        <div class="head-text-container"><div class="head-text">History</div></div>
      ...
      <div class="unique-experiment-container">
        <div class="head-text-container"><div class="head-text">Unique Experiment</div></div>
        <div class="about-content">
      ...
      <div class="about-efforts-container">
        <div class="head-text-container"><div class="head-text">Humble Beginnings and Herculean Efforts</div></div>
        <div class="about-content">
