		...
		<nav>
			<ul class="menus nohighlights noselect ">
				...
				<li class="menu-items">
					...
					<ul class="dropdown">
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/aero-home">Aeronautical Engineering</a></li>
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/auto-home">Automobile Engineering</a></li>
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/ece-home">Electronics Engineering</a></li>
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/instrumentation-home">Instrumentation Engineering</a></li>
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/pt-home">Production Technology</a></li>
						<li class="menu-items"><a target="_blank" href="https://mitindia.edu/en/rpt-home">Rubber and Plastics Technology</a></li>
						<li class="menu-items"><a target="_blank" href="http://www.it.mitindia.edu/">Information Technology</a></li>
						<li class="menu-items"><a target="_blank" href="http://www.ct.mitindia.edu/dct/#/home">Computer Technology</a></li>
						<li class="menu-items"><a target="_blank" href="http://www.dash.mitindia.edu/">Applied Sciences and Humanities</a></li>
					</ul>
				</li>
				<li class="menu-items">
					<button type="button" aria-haspopup="menu" aria-expanded="false">
					...
					<ul class="dropdown  ">
						...
						<li class="menu-items"><a class="" href="/administration/officestaff">Dean Office Staff</a></li>
						<li class="menu-items"><a class="" href="/administration/officestaff">Maintenance Office Staff</a></li>
					</ul>
				</li>
				<li class="menu-items">
					<button type="button" aria-haspopup="menu" aria-expanded="false">
					...
					<ul class="dropdown  ">
						<li class="menu-items">
							...
							<ul class="dropdown dropdown-submenu ">
								<li class="menu-items"><a class="" href="https://cfr.annauniv.edu/">Centre for Research</a></li>
								<li class="menu-items"><a class="" href="https://cac.annauniv.edu/">Centre for Academic Courses</a></li>
						...
						<li class="menu-items">
							...
							<ul class="dropdown dropdown-submenu ">
								...
								<li class="menu-items"><a class="" href="http://www.ciot.mitindia.edu/">Centre for Internet of Things</a></li>
								<li class="menu-items"><a class="" href="https://mitindia.edu/en/research-centres/mit_scoe">Siemens Centre of Excellence</a></li>
								<li class="menu-items"><a class="" href="https://mitindia.edu/en/research-centres/ceat_mit">Centre for Excellence in Automobile Technology</a></li>
								<li class="menu-items"><a class="" href="https://cra.mitindia.edu/">Centre for Robotics and Automation </a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li class="menu-items">
					...
					<ul class="dropdown  ">
						...
						<li class="menu-items"><a class="" href="https://mitindia.edu/en/alumni-home">MITAA</a></li>
					</ul>
				</li>
