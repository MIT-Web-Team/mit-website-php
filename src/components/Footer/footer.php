...
<div class="footer-container">
    <footer>
        <div class="footer-wrapper">
            ...
            <div class="copyright">© 2023 All Rights Reserved By <a href="#!"> @MIT WebTeam </a></div>
        </div>
    </footer>
</div>